...
INSERT INTO `goods` VALUES ('5', '杜宾', '/picture/5-1.jpg', '/picture/5-2.jpg', '/picture/5-3.jpg', '4900', '杜宾犬即笃宾犬。原产德国，它是根据培育这一品系人的名字路易斯·杜宾曼先生命名的，是所有品系中极富智慧的并且身体结构最为优秀，气质最为高贵的一种。', '10', '3');
...
INSERT INTO `goods` VALUES ('10', '博美', '/picture/10-1.jpg', '/picture/10-2.jpg', '/picture/10-3.jpg', '1028', '博美是一种紧凑、短背、活跃的玩赏犬，学名哈多利系博美犬（俗称英系博美犬），是德国狐狸犬的一种，原产德国。它拥有柔软、浓密的底毛和粗硬的皮毛。', '10', '5');
INSERT INTO `goods` VALUES ('11', '柯基', '/picture/11-1.jpg', '/picture/11-1.jpg', '/picture/11-1.jpg', '1888', '威尔士柯基犬是一种小型犬，但性格非常稳健，完全没有一般小型犬的神经质，是非常适合小孩的守护犬。它们的胆子很大，也相当机警，能高度警惕地守护家园，是最受欢迎的小型护卫犬之一。', '10', '5');
INSERT INTO `goods` VALUES ('12', '雪纳瑞', '/picture/12-1.jpg', '/picture/1-2.jpg', '/picture/12-1.jpg', '3666', '雪纳瑞犬是梗类犬的一种，起源于15世纪的德国，是唯一在梗犬类中不含英国血统的品种。其名字Schnauzer是德语的“口吻”之意，他们精力充沛、活泼、聪明。', '10', '5');
INSERT INTO `goods` VALUES ('13', '泰迪棕色', '/picture/13-1.jpg', '/picture/13-1.jpg', '/picture/13-1.jpg', '800', '贵宾犬（Poodle），也称“贵妇犬”，又称“卷毛狗”，在德语中，Pudel是“水花飞溅”的意思，是犬亚科犬属的一种动物。贵宾犬的来源就像它为了拖出猎禽所涉过的水一样浑浊不清。', '10', '5');
INSERT INTO `goods` VALUES ('14', '比熊', '/picture/14-1.jpg', '/picture/14-1.jpg', '/picture/14-1.jpg', '999', '比熊犬（法语：Bichon Frisé，意指“白色卷毛的玩赏用小狗”）原产于地中海地区，是一种小型犬品种。它们不会自然脱毛，因此毛发需要整理。颜色一般白色。 原称巴比熊犬，后缩为比熊犬。怀疑是巴比特犬和水猎融犬的后裔。是一种娇小的、强健的白色粉扑型的狗，具有欢快的性格，从它羽毛般欢快地卷在背后的尾巴和好奇的眼神中就能体现出来。', '10', '5');
INSERT INTO `goods` VALUES ('15', '茶杯泰迪', '/picture/15-1.jpg', '/picture/15-2.jpg', '/picture/15-3.jpg', '1122', '茶杯泰迪犬并非是真的可以把泰迪放入茶杯中，只是因为体型小而称为茶杯泰迪犬。茶杯型泰迪犬，在外形上和玩具泰迪熊犬类似，肩高不超过8英寸（20.32厘米）的犬，称作茶杯泰迪犬，又叫茶杯泰迪贵宾犬。', '10', '5');
INSERT INTO `goods` VALUES ('16', '柴犬', '/picture/16-1.jpg', '/picture/16-2.jpg', '/picture/16-3.jpg', '2000', '柴犬是体型中等并且又最古老的犬。柴犬能够应付陡峭的丘陵和山脉的斜坡，拥有灵敏的感官，使得柴犬屡次成为上乘的狩猎犬。柴犬性格活泼、好动。对自己喜欢的玩具、会一天到晚的把玩。', '10', '4');
INSERT INTO `goods` VALUES ('17', '斗牛犬', '/picture/17-1.jpg', '/picture/17-2.jpg', '/picture/17-3.jpg', '5000', '柴犬是体型中等并且又最古老的犬。柴犬能够应付陡峭的丘陵和山脉的斜坡，拥有灵敏的感官，使得柴犬屡次成为上乘的狩猎犬。柴犬性格活泼、好动。对自己喜欢的玩具、会一天到晚的把玩。', '10', '4');
...
INSERT INTO `users` VALUES ('1', '1', 'iUOoOdMAl7FsB1Kig37hmg==', null, null, null);
